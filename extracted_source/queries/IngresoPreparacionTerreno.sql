...
SELECT programacionCultivos.codigosistema, programacionCultivos.codSemilla, programacionCultivos.fechasiembra, "PreparacionTerreno" AS Actividad, Format$(([fechasiembra]),"ww",0,0) AS semana1, 1.5 AS cMin, programacionCultivos.lote, programacionCultivos.cama, programacionCultivos.numeroPlantasSembradas, "PreparacionTerreno" AS Detalle, 1.46 AS costo, "Min" AS unidad
